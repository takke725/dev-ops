...
* 用語学習用プロンプト（テンプレ型 / 記事下書き型）
* テンプレートプロジェクト生成など、AI への要件定義プロンプト
* Codex / Claude Code に渡す「再利用可能な指示セット」

> 目的：毎回ゼロから指示を書かず、品質と再現性を上げる
...
ops/
  ...
  prompt/
    01_*.md             # 用語学習プロンプト（テンプレ型）
    02_*.md             # 用語学習プロンプト（記事下書き型）
    03_*.md             # テンプレ生成などの要件プロンプト
  catalog/
    apps.yaml           # アプリ台帳（必須）
